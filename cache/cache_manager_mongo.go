...
func (m *MongoManager) getConcreteCacheObject(k string, collectionName string) (value *KeyValue, err error) {
...
func (m *MongoManager) Create(data KeyValue, collectionName string) error {
	c := m.DB.C(collectionName).With(m.DB.Session.Copy())
	defer c.Database.Session.Close()
...
func (m *MongoManager) Get(k string, collectionName string) (*KeyValue, error) {
